export default function HiringSection() {
    return (
      <section className="bg-white w-full px-4 py-4 lg:py-12 flex flex-col items-center text-center">
        ...
        {/* Decorative Line */}
        <div className="w-10 h-0.5 bg-[#c0b3a6] my-2 lg:my-4" />
  
        {/* Paragraph */}
        <div className="bg-[#f7f7f7] w-full mt-6 px-2 lg:px-52 py-4 lg:py-8 ">
          <p className="text-sm md:text-base text-[#333] leading-relaxed">
            When you post with Fusion-Foodies, rest assured that you’ll receive a manageable number of exceptional
            candidates tailored to your needs – guaranteed. Our mission isn’t just about making a profit; it’s about
