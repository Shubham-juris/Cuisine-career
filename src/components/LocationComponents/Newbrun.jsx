  ...
  return (
    <div className="text-[#4a443f] max-w-4xl mx-auto px-4 py-6 font-serif">
      ...
      <p className="font-bold text-lg text-gray-800 mb-2">
        Position: {job_posting.position.title}
      </p>
      <p className="text-gray-700 mb-1">
        Organization: {job_posting.position.organization}
      </p>
      <p className="text-gray-700 mb-4">
        Location: {job_posting.position.location}
      </p>
      <p className="mt-4 text-gray-700">{job_posting.description}</p>

      <SectionHeader title="Role" />
      <p className="text-gray-700">{job_posting.role}</p>
      ...
      <p className="mt-2 text-gray-700">{job_posting.how_to_apply}</p>
    </div>
  );
};

export default Newbrun;